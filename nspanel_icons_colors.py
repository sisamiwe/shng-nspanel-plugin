...
class ColorThemes(object):
    colorMap = {
        ...
        'exceptional':      {'red': 255, 'green':  50, 'blue':  50},  # red
        'fog':              {'red': 150, 'green': 150, 'blue': 150},  # 75% grey
        'hail':             {'red': 200, 'green': 200, 'blue': 200},  # white
        'lightning':        {'red': 200, 'green': 200, 'blue':   0},  # golden-yellow
        'lightning_rainy':  {'red': 200, 'green': 200, 'blue': 150},  # dark-golden-yellow
        'partlycloudy':     {'red': 150, 'green': 150, 'blue': 150},  # 50% grey
        'pouring':          {'red':  50, 'green':  50, 'blue': 255},  # blue
        'rainy':            {'red': 100, 'green': 100, 'blue': 255},  # light-blue
        'snowy':            {'red': 150, 'green': 150, 'blue': 150},  # white
        'snowy_rainy':      {'red': 150, 'green': 150, 'blue': 255},  # light-blue-grey
    ...
    def GetColor(self, color) -> int:
        if isinstance(color, str):
            color = self.colorMap.get(color, {'red': 255, 'green': 255, 'blue': 255})
        if isinstance(color, dict):
            color = rgb_dec565(color)
